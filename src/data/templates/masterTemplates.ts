...
export const templateSweetMoment: TemplateData = {
  ...
  backgroundGradient: 'linear-gradient(135deg, #FFFDF9 0%, #FAF5EE 50%, #F3EBE1 100%)',
...
export const templateSpecialDay: TemplateData = {
  ...
  backgroundGradient: 'linear-gradient(135deg, #FFFDFB 0%, #FDFBF7 50%, #F5EFE6 100%)',
...
export const templateFilmStory: TemplateData = {
  ...
  backgroundGradient: 'linear-gradient(135deg, #27272A 0%, #141416 50%, #09090B 100%)',
...
export const templateMovieLove: TemplateData = {
  ...
  backgroundGradient: 'linear-gradient(135deg, #3B5377 0%, #2B4162 50%, #1A2A42 100%)',
  backgroundTexture: 'vintage-paper',
...
export const templateBetterTogether: TemplateData = {
  ...
  backgroundGradient: 'linear-gradient(135deg, #FFFFFF 0%, #FAFAF7 50%, #F0F0EC 100%)',
  backgroundTexture: 'paper',
...
export const templateDailyChronicle: TemplateData = {
  ...
  backgroundGradient: 'linear-gradient(135deg, #FAF7F2 0%, #F4F0EA 50%, #E8DFD3 100%)',
  backgroundTexture: 'vintage-paper',
